interface SidebarProps {
  activePage: string;
  onNavigate: (page: 'write' | 'settings' | 'favorites') => void;
  favoritesCount: number;
}

export function Sidebar({ activePage, onNavigate, favoritesCount }: SidebarProps) {
  const isWriteActive = activePage === 'write' || activePage === 'result';

  return (
    <aside className="sidebar">
      <div className="sidebar-brand">L</div>

      <nav className="sidebar-nav">
        <button
          className={`sidebar-item ${isWriteActive ? 'active' : ''}`}
